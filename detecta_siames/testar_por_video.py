...
while True:
    ...
    #mapeia a mima, usando o cascade carregado
    objetos = xml.detectMultiScale(img, 1.2, 5)

    
    for (x, y, w, h) in objetos:
        #desenha um retângulo em volta da Mima
        cv2.rectangle(img, (x, y+10), (x+w, y+h), (0, 0, 255), 2)
        #escreve um texto em cima do retângulo
        cv2.putText(img, 'MIMA',(x,y), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (0,0,0), 1, cv2.LINE_AA)
